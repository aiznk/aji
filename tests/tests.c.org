...
#define trv_cleanup \
    AjiLexEnv_DelWithChilds(lex_env); \
    AjiGC_Del(gc); \
    AjiAST_Del(ast); \
    AjiTkr_Del(tkr); \
    AjiGlobal_Destroy(); \
...
test_util_Aji_SafeSystem(void) {
    ...
    assert(AjiFile_SolveFmt(cmd, sizeof cmd, "/bin/sh -c \"touch %s\"", path) != NULL);
...
static void
test_util_Aji_CompileArgv(void) {
    AjiConfig *config = AjiConfig_New();
    int argc = 4;
    char *argv[] = {
        "make",
    ...
    char *compiled = Aji_CompileArgv(config, NULL, argc-1, argv+1, src);
...
util_tests[] = {
    ...
    {"Aji_CompileArgv", test_util_Aji_CompileArgv},
...
/*
    AjiTkr_Parse(tkr, "{@ 1, \"abc\", var, alias.set(\"\", \"\") @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
*/
    AjiTkr_Parse(tkr, "{@ a = 0 \n b = 0 \n a += 1, b += 2 @}{: a :} {: b :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1 2"));
    }
...
test_trv_negative_0(void) {
    ...
    AjiTkr_Parse(tkr, "{: 1 + -1 :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "0"));
    }
...
test_trv_dot_0(void) {
    ...
    AjiTkr_Parse(tkr, "{: \"ABC\".lower().upper() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
/*
    AjiTkr_Parse(tkr, "{: alias.set(\"a\", \"b\") :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetAliasValue(lex_env, "a"), "b"));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "nil"));
    }
*/
    AjiGC_Del(gc);
    AjiAST_Del(ast);
...
test_trv_dot_4(void) {
    ...
    "@}{: n :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "4"));
    }
...
test_trv_builtin_string(void) {
    ...
    ********/
    ...
    AjiTkr_Parse(tkr, "{: nil.upper() :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"upper\" is not defined"));
    }
    ...
    ********/
    ...
    AjiTkr_Parse(tkr, "{: nil.lower() :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"lower\" is not defined"));
    }
    ...
    *************/
    ...
    AjiTkr_Parse(tkr, "{: \"abc\".capitalize() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{: nil.capitalize() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"capitalize\" is not defined"));
    }
    ...
    ********/
    ...
    AjiTkr_Parse(tkr, "{: \"abcDef\".snake() :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abc_def"));
    }

    AjiTkr_Parse(tkr, "{@ a = \"abcDef\" \n @}{: a.snake() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{: nil.snake() :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"snake\" is not defined"));
    }
    ...
    ********/
    ...
    AjiTkr_Parse(tkr, "{: \"camel_case\".camel() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "camelCase"));
    }

    AjiTkr_Parse(tkr, "{@ a = \"camel_case\" \n @}{: a.camel() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{: nil.camel() :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"camel\" is not defined"));
    }
...
test_trv_builtin_unicode_split(void) {
    ...
    );
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "3"));
    }
...
test_trv_builtin_unicode_rstrip(void) {
    ...
    AjiTkr_Parse(tkr, "{@ s = \"abcdef\".rstrip(\"def\") @}"
        "{: s :}"
    );
    {
        AjiAST_Clear(ast);
...
test_trv_builtin_unicode_lstrip(void) {
    ...
    AjiTkr_Parse(tkr, "{@ s = \"defabc\".lstrip(\"def\") @}"
        "{: s :}"
    );
    {
        AjiAST_Clear(ast);
...
test_trv_builtin_unicode_strip(void) {
    ...
    AjiTkr_Parse(tkr, "{@ s = \"defabcdef\".strip(\"def\") @}"
        "{: s :}"
    );
    {
        AjiAST_Clear(ast);
...
test_trv_builtin_functions(void) {
    ...
    *******/
    ...
    AjiTkr_Parse(tkr, "{@ puts() @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "\n"));
    }

    AjiTkr_Parse(tkr, "{@ puts(1) @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ puts(1, \"abc\") @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1 abc\n"));
    }

    AjiTkr_Parse(tkr, "{@ puts(\"abc\") @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    ********/
    ...
    AjiTkr_Parse(tkr, "{@ eputs(1) @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStderrBufSuperGlobal(lex_env), "1\n"));
    }

    AjiTkr_Parse(tkr, "{@ eputs() @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStderrBufSuperGlobal(lex_env), "\n"));
    }

    AjiTkr_Parse(tkr, "{@ eputs(1, 2) @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStderrBufSuperGlobal(lex_env), "1 2\n"));
    }

    AjiTkr_Parse(tkr, "{@ eputs(1, \"abc\") @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStderrBufSuperGlobal(lex_env), "1 abc\n"));
    }

    AjiTkr_Parse(tkr, "{@ eputs(\"abc\") @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStderrBufSuperGlobal(lex_env), "abc\n"));
    }
...
test_trv_builtin_modules_vec_1(void) {
    ...
    "@}{: vec[0] :},{: vec[1] :},{: vec[2] :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "0,1,2"));
    }
...
test_trv_builtin_functions_type_dict(void) {
    ...
    AjiTkr_Parse(tkr, "{@ def f(d): end @}{: f(1) :}");
    {
        AjiAST_Clear(ast);
        (AjiCC_Compile(ast, AjiTkr_GetToks(tkr)));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ def f(d): end @}{: f({\"a\": 1}) :}");
    {
        AjiAST_Clear(ast);
        (AjiCC_Compile(ast, AjiTkr_GetToks(tkr)));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{: type({ \"a\": 1 }) :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "(type)"));
    }
...
test_trv_ref_block(void) {
    ...
    AjiTkr_Parse(tkr, "{: 1 :}{@@}{: 2 :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "12"));
    }

    AjiTkr_Parse(tkr, "{: 2 * 3 + 1 :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "7"));
    }

    AjiTkr_Parse(tkr, "{: \"ab\" * 4 :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abababab"));
    }
...
test_trv_text_block(void) {
    ...
    AjiTkr_Parse(tkr, "1{@@}2{@@}3");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "123"));
    }

    AjiTkr_Parse(tkr, "1{: 2 :}3{: 4 :}5");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "12345"));
    }
...
test_trv_import_stmt_0(void) {
    ...
    **********************/
    ...
    AjiTkr_Parse(tkr, "{@ import \"tests/lang/modules/hello.aji\" as hello @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "imported\n"));
    }

    AjiTkr_Parse(tkr, "{@ import \n \"tests/lang/modules/hello.aji\" as hello @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ import \"tests/lang/modules/hello.aji\" \n as hello @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ import \"tests/lang/modules/hello.aji\" as \n hello @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        ...
        "@}{: count.n :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "45"));
    }
    ...
    ************************/
    ...
    AjiTkr_Parse(tkr,
        "{@ from \"tests/lang/modules/funcs.aji\" import f1 @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        assert(!AjiAST_HasErrs(ast));
    ...
    AjiTkr_Parse(tkr,
        "{@ from \"tests/lang/modules/funcs.aji\" import ( f1, f2 ) @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        assert(!AjiAST_HasErrs(ast));
    ...
    AjiTkr_Parse(tkr,
        "{@ from \"tests/lang/modules/funcs.aji\" import (\nf1,\nf2,\n) @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        assert(!AjiAST_HasErrs(ast));
    ...
    AjiTkr_Parse(tkr,
        "{@ from \"tests/lang/modules/funcs.aji\" \n import ( f1, f2 ) \n "
        "   f1() \n f2() @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
...
test_trv_import_stmt_2(void) {
        ...
        "@}{: count :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"count\" is not defined in ref block"));
    }
...
test_trv_if_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 1: puts(1) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_if_stmt_2(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 1: if 1: puts(1) end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 1: if 1: puts(1) \nend end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 1: if 1: puts(1) end \nend @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_if_stmt_3(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 1: @}{@ if 1: @}1{@ end @}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 1: @}{@ if 1: @}1{@ end \n@}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_if_stmt_4(void) {
    ...
    AjiTkr_Parse(tkr, "{@ i = 1 @}{@ if i: puts(1) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_if_stmt_9(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "6\n"));
    }
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "24\n2000\n"));
    }
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "2000\n"));
    }
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "20\n2000\n"));
    }
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "200\n20\n2000\n"));
    }
...
test_trv_elif_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: puts(1) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: puts(1) \nend @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_elif_stmt_1(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ elif 1: @}1{@ \nend @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ elif 1: @}1{@ end \n@}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_elif_stmt_2(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: if 1: puts(1) end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: if 1:\n puts(1) end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: if 1: puts(1)\n end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: elif 1: if 1: puts(1) end\n end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_elif_stmt_3(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ elif 1: @}{@ if 1: @}1{@ end @}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ elif 1: @}{@ if 1: @}1{@ \nend @}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ elif 1: @}{@ if 1: @}1{@ end \n@}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_elif_stmt_4(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"i\" is not defined"));
    }
...
test_trv_elif_stmt_6(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "23\n"));
    }
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "31\n"));
    }
...
test_trv_elif_stmt_7(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "123456"));
    }
...
test_trv_else_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: puts(1) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: puts(1) \nend @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_else_stmt_1(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ else: @}1{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_else_stmt_2(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: if 1: puts(1) end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: if 1:\n puts(1) end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: if 1: puts(1)\n end end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: else: if 1: puts(1) end \nend @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_else_stmt_3(void) {
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ else: @}{@ if 1: @}1{@ end @}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ else: @}{@ if 1: @}1{@ \nend @}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ if 0: @}{@ else: @}{@ if 1: @}1{@ end \n@}{@ end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_for_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ for i=0; i<2; i +=1: puts(i) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ size=0 for i=size; i<2; i += 1: puts(i) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ for i=0; i<2; i +=1: \nputs(i) end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ for i=0; i<2; i +=1: puts(i)\n end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_for_stmt_1(void) {
    ...
    AjiTkr_Parse(tkr, "{@ i=0 for i<2: puts(i)\ni+=1 end @}");
    {
        AjiAST_Clear(ast);
        (AjiCC_Compile(ast, AjiTkr_GetToks(tkr)));
        AjiLexEnv_Clear(lex_env);
...
test_trv_for_stmt_2(void) {
    ...
    AjiTkr_Parse(tkr, "{@ for i, j = 0, 0; i != 4; i += 1, j += 2: end @}{: i :},{: j :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "4,8"));
    }
...
test_trv_for_stmt_4(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "yoyo\nyo\n\n"));
    }
...
test_trv_for_stmt_5(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "012"));
    }
...
test_trv_for_stmt_8(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "0 0\n1 1\n"));
    }
...
test_trv_for_stmt_9(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "01"));
    }
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "000111"));
    }
...
test_trv_break_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ for: break end @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_break_stmt_3(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid break statement. not in loop"));
    }
...
test_trv_continue_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ j=0 for i=0; i<2; i+=1: continue\n j=i end @}{: j :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_continue_stmt_4(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid continue statement. not in loop"));
    }
...
test_trv_return_stmt_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ def f(): return 1 end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_return_stmt_4(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid return statement. not in function"));
    }
...
test_trv_block_stmt_0(void) {
    ...
    "@}");
    {
        ...
        (AjiCC_Compile(ast, AjiTkr_GetToks(tkr)));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "can't access to function node"));
    }
...
test_trv_inject_stmt_0(void) {
    ...
    "@}");
    {
        ...
        (AjiCC_Compile(ast, AjiTkr_GetToks(tkr)));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "inject statement needs function"));
    }
...
test_trv_inject_stmt_1(void) {
    ...
    "@}");
    {
        ...
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "not found identifier in inject statement"));
    }
...
test_trv_struct_22(void) {
    ...
    "@}{: vec[0].a :},{: vec[1].a :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "2,2"));
    }
...
test_trv_struct_23(void) {
    ...
    "@}{: d[\"a\"].a :},{: d[\"b\"].a :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1,1"));
    }
...
test_trv_func_def_1(void) {
    ...
    AjiTkr_Parse(tkr, "{@ def f(a, b): puts(a, b) end f(1, 2) @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_func_def_4(void) {
    ...
    AjiTkr_Parse(tkr, "{@ i = 1 \n def f(): puts(i) end \n f() @}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(ast->ref_lex_env), "1\n"));
    }
...
test_trv_func_def_5(void) {
    ...
    AjiTkr_Parse(tkr, "{@ def f(arg): end \n f() @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_func_def_7(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "    program\n\n    comment\n"));
    }
...
test_trv_func_def_11(void) {
    ...
    AjiTkr_Parse(tkr, "{@ def f(a): return a end @}{: f(1) :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ def f(a, b): return a + b end @}{: f(1, 2) :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ def f(): return true end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "true"));
    }

    AjiTkr_Parse(tkr, "{@ def f(): return 0 end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ def f(): return 1 + 2 end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ def f(): @}abc{@ end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abcnil"));
    }

    AjiTkr_Parse(tkr, "{@ def f(): @}abc{@ a = 1 @}def{@ end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abcdefnil"));
    }

    AjiTkr_Parse(tkr, "{@ def f(): @}abc{@ a = 1 @}{: a :}{@ end @}{: f() :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abc1nil"));
    }

    AjiTkr_Parse(tkr, "{@ def f(a): @}{: a :}{@ b = 123 @}{: b :}{@ end @}{: f(\"abc\") :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "abc123nil"));
    }
    ...
    );
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "hi\n"));
    }
    ...
    );
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "0,1"));
    }
...
test_trv_inject_stmt_10(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "can't inject. not found extended function"));
    }
...
test_trv_inject_stmt_13(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "<h1>The title</h1>"));
    }
...
test_trv_inject_stmt_15(void) {
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1 3\n"));
    }
...
test_trv_comparison_1(void) {
    ...
    AjiTkr_Parse(tkr, "{: 1 != 1 :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "false"));
    }
...
test_trv_asscalc_1(void) {
    ...
    *******/
    ...
    AjiTkr_Parse(tkr, "{@ 1 -= 1 @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid left hand operand type (1)"));
    }

    AjiTkr_Parse(tkr, "{@ true -= 1 @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid left hand operand type (3)"));
    }
    ...
    AjiTkr_Parse(tkr, "{@ a = 0 \n a -= \"c\" @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid right hand operand type (5)"));
    }
...
test_trv_asscalc_3(void) {
    ...
    *****/
    ...
    AjiTkr_Parse(tkr, "{@ a = true \n a /= true @}{: a :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1.0"));
    }

    AjiTkr_Parse(tkr, "{@ a = false \n a /= true @}{: a :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    *******/
    ...
    AjiTkr_Parse(tkr, "{@ 4 /= 2 @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid left hand operand (1)"));
    }

    AjiTkr_Parse(tkr, "{@ true /= 2 @}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid left hand operand (3)"));
    }
    ...
    AjiTkr_Parse(tkr, "{@ a = 4 \n a /= false @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "zero division error"));
    }
    ...
    AjiTkr_Parse(tkr, "{@ a = 4 \n a /= \"b\" @}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "invalid right hand operand (5)"));
    }
...
test_trv_expr_3(void) {
    ...
    "@}{: r :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "[1, 2, 3]"));
    }
...
test_trv_expr_5(void) {
    ...
    "@}{: r :}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "19"));
    }
...
test_trv_vec_3(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "0 abc nil 0 1\ntrue\ntrue\ntrue\ntrue\ntrue\ntrue\ntrue\n"));
    }
...
test_trv_vec_4(void) {
    ...
    "@}{: a[0] :}{: a[1] :}{: a[2] :}{: a[3] :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1234"));
    }
...
test_trv_dict_2(void) {
    ...
    *******/
    ...
    "@}{: d[\"b\"] :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "not found key \"b\""));
    }
...
test_trv_builtin_vec_0(void) {
    ...
    AjiTkr_Parse(tkr, "{: len([1, 2].push(3)) :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_builtin_dict_0(void) {
    ...
    AjiTkr_Parse(tkr, "{@ d = {\"a\": 1} @}{: d.get(1) :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "key is not found"));
    }

    AjiTkr_Parse(tkr, "{@ d = {\"a\": 1} @}{: d.get(\"a\") :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
    ...
    AjiTkr_Parse(tkr, "{@ d = {\"a\": 1} @}{: d.get(\"b\") :}");
    {
        AjiAST_Clear(ast);
        AjiCC_Compile(ast, AjiTkr_GetToks(tkr));
        AjiLexEnv_Clear(lex_env);
...
test_trv_chain_object(void) {
    ...
    *******/
    ...
    "@}");
    {
        ...
        (AjiTrv_Trav(ast, lex_env));
        assert(AjiAST_HasErrs(ast));
        assert(!strcmp(AjiAST_GetcFirstErrMsg(ast), "\"a\" is not defined"));
    }
...
test_trv_etc_0(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "***i love life***\n*\n*\n*\ni\n \nl\no\nv\ne\n \nl\ni\nf\ne\n*\n*\n*\n"));
    }
...
test_trv_etc_2(void) {
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "<html>\n"
            "<head>\n"
...
test_trv_etc_4(void) {
    ...
    ***************************/
    ...
    "@}{: a :},{: id(a) == id(f) :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "(function),true"));
    }
...
test_trv_etc_5(void) {
    ...
    ***************************/
    ...
    "@}{: d[\"a\"] :},{: d[\"b\"] :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "2,3"));
    }
...
test_trv_etc_6(void) {
    ...
    ***************************/
    ...
    "@}{: l[2] :},{: id(l[2]) != id(g) :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "3,true"));
    }
...
test_trv_etc_7(void) {
    ...
    *******************************/
    ...
    "@}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "nyan\nnyan\n"));
    }
...
"@}";
    ...
    AjiTkr_Parse(tkr, s);
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "1 2 3 4\n"));
    }
...
"@}";
    ...
    AjiTkr_Parse(tkr, s);
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "2 1 3 4\n"));
    }
...
test_trv_unicode_0(void) {
    ...
    "@}{: s[0] :}");
    {
        ...
        AjiTrv_Trav(ast, lex_env);
        assert(!AjiAST_HasErrs(ast));
        assert(!strcmp(AjiLexEnv_GetcStdoutBufSuperGlobal(lex_env), "a"));
    }
...
test_try_catch_stmt_5(void) {
    ...
    check_ok("{@ def func(): try: 1 += 1 catch: puts(1) end end func() @}", "1\n");
    check_ok("{@ def func(): try: 1 += 1 catch TypeError as e: puts(e.what()) end end func() @}", "invalid left hand operand (1)\n");
